...
const Nav: React.FC = () => {
    const [burgerMenu, setBurgerMenu] = useState<boolean>(false)  // ✅ Fixed
    ...
    return (
        <div className='flex flex-col lg:flex-row justify-between items-start lg:items-center w-full px-6 lg:px-16 py-9'>
            <div className='hidden lg:flex flex-wrap space-x-6 text-2xl max-w-sm w-full text-dark-red font-medium'>
            ...
            <div className='flex items-center justify-between w-full lg:w-auto h-10'>
                ...
                <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-not-verylight-pink nav-h1 font-bold'>
