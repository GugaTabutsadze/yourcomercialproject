...
const Subsection = () => {
  return (
    <div className='flex flex-col items-center mt-[150px] px-10'>
      <div >
        <h1 className='text-4xl md:text-6xl  font-semibold text-darker-green'>Compability</h1>
      </div>
      <div>
        <p className='text-2xl mt-[50px] text-center text-darker-green'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis provident vitae deleniti quae magni possimus.</p>
      </div>
